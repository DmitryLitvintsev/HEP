...
//    fitFun->SetParameter(0,2135);
//   fitFun->SetParameter(1,bw);
//   fitFun->SetParameter(2,0.0056);
...
//   fitFun->SetParameter(8,2225.7864);
//   fitFun->SetParameter(9,-1.8126);
//   fitFun->SetParameter(10,1.7184);
//   fitFun->SetParameter(11,-0.5594);

  fitFun->SetParameter(0,386);
  fitFun->SetParameter(1,bw);
  fitFun->SetParameter(2,0.0058);
  fitFun->SetParameter(3,0.0091);
  fitFun->SetParameter(4,1.5320);
  fitFun->SetParameter(5,number);
  fitFun->SetParameter(6,0.008);
...
//  fitFun->SetParLimits(5,-1000,10000);
//  fitFun->SetParLimits(6,sigma-0.0012,sigma+0.0012);
//  fitFun->SetParLimits(7,mass-0.002,mass+0.002);
