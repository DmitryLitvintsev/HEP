...
void ddst1(TH1* h,int npar=3,double hLow=-1, double hHigh=-1, double mass=1.53,double sigma=0.003) {
  ...
  TF1* fitFun = new TF1("ddst",ddst,low,hig,12);
  ...
  fitFun->SetParameter(3,0.0202);
  fitFun->SetParameter(4,0.4138);

  fitFun->SetParameter(9,0.0);
  fitFun->SetParameter(10,.0242);
  fitFun->SetParameter(11,0.4557);
