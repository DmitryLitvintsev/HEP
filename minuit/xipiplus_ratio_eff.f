...
C*
      ...
      open(unit=21,file='fcn_xipiplus_ratio_eff_jet20.dat',
     &     status='unknown',form='formatted')
      open(unit=22,file='func_xipiplus_ratio_eff_jet20.dat',
     &     status='unknown',form='formatted')
      open(unit=23,file='emat_xipiplus_ratio_eff_jet20.dat',
     &     status='unknown',form='formatted')
      open(unit=24,file='ul_xipiplus_ratio_eff_jet20.dat',
     &     status='unknown',form='formatted')
C      open(unit=6,file='fit.out',status='unknown',form='formatted')
      ...
      DOUBLE PRECISION GCM,GCS,GCG,GCE,CONSTR
      INTEGER NPARM
      PARAMETER(NPARM=14)
...
C*
 ...
 1004     FORMAT( G20.10 )
       ...
       WRITE(24,1005  )I90,I95,1.D0/1000.D0*DFLOAT(I90-1)/INTEGRAL,
     &      1.D0/1000.D0*DFLOAT(I95-1)/INTEGRAL
