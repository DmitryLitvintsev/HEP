...
C*   Open data files
C*
      open(unit=5,file='xicst_amplitude_fat.data',status='old')
      open(unit=21,file='fcn_xicst_amplitude_fat_jet.dat',
     &     status='unknown',form='formatted')
      open(unit=22,file='func_xicst_amplitude_fat_jet.dat',
     &     status='unknown',form='formatted')
      open(unit=23,file='emat_xicst_amplitude_fat_jet.dat',
     &     status='unknown',form='formatted')
      open(unit=24,file='ul_xicst_amplitude_fat_jet.dat',
     &     status='unknown',form='formatted')
 ...
 100  SUM=0.D0
      ...
      SUM=U(1)*INTEGRAL+U(10)*INTEGRAL1+
