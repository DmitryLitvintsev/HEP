...
C*
      ...
      open(unit=21,file='fcn_xipiminus_amplitude.dat',
     &     status='unknown',form='formatted')
      open(unit=22,file='func_xipiminus_amplitude.dat',
     &     status='unknown',form='formatted')
      open(unit=23,file='emat_xipiminus_amplitude.dat',
     &     status='unknown',form='formatted')
      open(unit=24,file='ul_xipiminus_amplitude.dat',
     &     status='unknown',form='formatted')
