...
C
      ...
      NDATA=1
      OPEN(UNIT=80,FILE='data_points_unique_ws.dat')
...
C*   Open data files
C*
      open(unit=5,file='xipiminus_ratio_eff.data',status='old')
      open(unit=21,file='fcn_xipiminus_ratio_eff.dat',
     &     status='unknown',form='formatted')
      open(unit=22,file='func_xipiminus_ratio_eff.dat',
     &     status='unknown',form='formatted')
      open(unit=23,file='emat_xipiminus_ratio_eff.dat',
     &     status='unknown',form='formatted')
      open(unit=24,file='ul_xipiminus_ratio_eff.dat',
     &     status='unknown',form='formatted')
...
C*
 ...
 1004     FORMAT( G20.10 )
       ...
       WRITE(24,1005  )I90,I95,DFLOAT(I90-1),
     &      DFLOAT(I95-1)
